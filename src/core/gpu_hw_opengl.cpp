...
bool GPU_HW_OpenGL::CreateFramebuffer()
{
  ...
  if (!m_vram_texture.Create(texture_width, texture_height, GL_RGB5_A1, GL_RGBA, GL_UNSIGNED_BYTE, nullptr, false,
                             true) ||
      ...
      !m_vram_read_texture.Create(texture_width, texture_height, GL_RGB5_A1, GL_RGBA, GL_UNSIGNED_BYTE, nullptr, false,
                                  true) ||
